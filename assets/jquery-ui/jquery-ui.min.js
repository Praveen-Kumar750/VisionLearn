...
!function(t) {
    ...
    t.widget = function(e, i, s) {
        var o, n, r, a = {}, h = e.split(".")[0], l = h + "-" + (e = e.split(".")[1]);
        return s || (s = i,
        i = t.Widget),
    ...
    t.widget.extend = function(e) {
        for (var s, o, n = i.call(arguments, 1), r = 0, a = n.length; a > r; r++)
            for (s in n[r])
                o = n[r][s],
                n[r].hasOwnProperty(s) && void 0 !== o && (e[s] = t.isPlainObject(o) ? t.isPlainObject(e[s]) ? t.widget.extend({}, e[s], o) : t.widget.extend({}, o) : o);
        return e
    }
    ,
    t.widget.bridge = function(e, s) {
        ...
        t.fn[e] = function(n) {
            ...
            return r ? this.length || "instance" !== n ? this.each((function() {
                ...
                return "instance" === n ? (h = s,
                !1) : s ? t.isFunction(s[n]) && "_" !== n.charAt(0) ? (i = s[n].apply(s, a)) !== s && void 0 !== i ? (h = i && i.jquery ? h.pushStack(i.get()) : i,
            ...
            this.each((function() {
                var e = t.data(this, o);
                e ? (e.option(n || {}),
                e._init && e._init()) : t.data(this, o, new s(n,this))
            }
            ))),
            h
        }
    ...
    t.Widget.prototype = {
        ...
        _toggleClass: function(t, e, i, s) {
            ...
            return n.element.toggleClass(this._classes(n), s),
            this
        },
        _on: function(e, i, s) {
            var o, n = this;
    ...
    function() {
        ...
        var s, o = Math.max, n = Math.abs, r = /left|center|right/, a = /top|center|bottom/, h = /[\+\-]\d+(\.[\d]+)?%?/, l = /^\w+/, c = /%$/, f = t.fn.position;
        t.position = {
            scrollbarWidth: function() {
                ...
                e === (i = n.offsetWidth) && (i = o[0].clientWidth),
                o.remove(),
                s = e - i
            },
        ...
        t.fn.position = function(s) {
            ...
            s = t.extend({}, s);
            var c, u, p, d, m, g, v = t(s.of), _ = t.position.getWithinInfo(s.within), y = t.position.getScrollInfo(_), b = (s.collision || "flip").split(" "), w = {};
            return g = function(e) {
                var i = e[0];
                return 9 === i.nodeType ? {
                    width: e.width(),
            ...
            1 === b.length && (b[1] = b[0]),
            "right" === s.at[0] ? m.left += u : "center" === s.at[0] && (m.left += u / 2),
            "bottom" === s.at[1] ? m.top += p : "center" === s.at[1] && (m.top += p / 2),
            c = e(w.at, u, p),
            m.left += c[0],
            m.top += c[1],
            this.each((function() {
                var r, a, h = t(this), l = h.outerWidth(), f = h.outerHeight(), g = i(this, "marginLeft"), x = i(this, "marginTop"), C = l + g + i(this, "marginRight") + y.width, P = f + x + i(this, "marginBottom") + y.height, I = t.extend({}, m), W = e(w.my, h.outerWidth(), h.outerHeight());
                "right" === s.my[0] ? I.left -= l : "center" === s.my[0] && (I.left -= l / 2),
                "bottom" === s.my[1] ? I.top -= f : "center" === s.my[1] && (I.top -= f / 2),
                I.left += W[0],
                I.top += W[1],
                r = {
                    marginLeft: g,
                ...
                t.each(["left", "top"], (function(e, i) {
                    t.ui.position[b[e]] && t.ui.position[b[e]][i](I, {
                        targetWidth: u,
                        targetHeight: p,
                        elemWidth: l,
                        elemHeight: f,
                ...
                s.using && (a = function(t) {
                    ...
                    l > u && u > n(e + i) && (c.horizontal = "center"),
                    f > p && p > n(r + a) && (c.vertical = "middle"),
                    c.important = o(n(e), n(i)) > o(n(r), n(a)) ? "horizontal" : "vertical",
        ...
        t.ui.position = {
            fit: {
                left: function(t, e) {
                    var i, s = e.within, n = s.isWindow ? s.scrollLeft : s.offset.left, r = s.width, a = t.left - e.collisionPosition.marginLeft, h = n - a, l = a + e.collisionWidth - r - n;
                    e.collisionWidth > r ? h > 0 && 0 >= l ? (i = t.left + h + e.collisionWidth - r - n,
                    t.left += h - i) : t.left = l > 0 && 0 >= h ? n : h > l ? n + r - e.collisionWidth : n : h > 0 ? t.left += h : l > 0 ? t.left -= l : t.left = o(t.left - a, t.left)
                },
                top: function(t, e) {
                    var i, s = e.within, n = s.isWindow ? s.scrollTop : s.offset.top, r = e.within.height, a = t.top - e.collisionPosition.marginTop, h = n - a, l = a + e.collisionHeight - r - n;
                    e.collisionHeight > r ? h > 0 && 0 >= l ? (i = t.top + h + e.collisionHeight - r - n,
                    t.top += h - i) : t.top = l > 0 && 0 >= h ? n : h > l ? n + r - e.collisionHeight : n : h > 0 ? t.top += h : l > 0 ? t.top -= l : t.top = o(t.top - a, t.top)
                }
            },
            flip: {
                left: function(t, e) {
                    var i, s, o = e.within, r = o.offset.left + o.scrollLeft, a = o.width, h = o.isWindow ? o.scrollLeft : o.offset.left, l = t.left - e.collisionPosition.marginLeft, c = l - h, f = l + e.collisionWidth - a - h, u = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, p = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0, d = -2 * e.offset[0];
                    0 > c ? (0 > (i = t.left + u + p + d + e.collisionWidth - a - r) || n(c) > i) && (t.left += u + p + d) : f > 0 && (((s = t.left - e.collisionPosition.marginLeft + u + p + d - h) > 0 || f > n(s)) && (t.left += u + p + d))
                },
                top: function(t, e) {
                    var i, s, o = e.within, r = o.offset.top + o.scrollTop, a = o.height, h = o.isWindow ? o.scrollTop : o.offset.top, l = t.top - e.collisionPosition.marginTop, c = l - h, f = l + e.collisionHeight - a - h, u = "top" === e.my[1] ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, p = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0, d = -2 * e.offset[1];
                    0 > c ? (0 > (s = t.top + u + p + d + e.collisionHeight - a - r) || n(c) > s) && (t.top += u + p + d) : f > 0 && (((i = t.top - e.collisionPosition.marginTop + u + p + d - h) > 0 || f > n(i)) && (t.top += u + p + d))
                }
            },
            flipfit: {
                left: function() {
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _mouseCapture: function(e, i) {
            ...
            t(e.target).parents().each((function() {
                return t.data(this, n.widgetName + "-item") === n ? (s = t(this),
                !1) : void 0
            }
            )),
        ...
        _intersectsWith: function(t) {
            var e = this.positionAbs.left
              ...
              , f = "x" === this.options.axis || s + l > a && h > s + l
              , u = "y" === this.options.axis || e + c > n && r > e + c
              , p = f && u;
        ...
        _intersectsWithPointer: function(t) {
            ...
            return !!(s && o) && (e = this._getDragVerticalDirection(),
        ...
        _getItemsAsjQuery: function(e) {
            ...
            if (l && e)
                for (s = l.length - 1; s >= 0; s--)
                    for (o = (n = t(l[s], this.document[0])).length - 1; o >= 0; o--)
                        (r = t.data(n[o], this.widgetFullName)) && r !== this && !r.options.disabled && h.push([t.isFunction(r.options.items) ? r.options.items.call(r.element) : t(r.options.items, r.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), r]);
        ...
        _refreshItems: function(e) {
            ...
            var i, s, o, n, r, a, h, l, c = this.items, f = [[t.isFunction(this.options.items) ? this.options.items.call(this.element[0], e, {
                item: this.currentItem
            }) : t(this.options.items, this.element), this]], u = this._connectWith();
            if (u && this.ready)
                for (i = u.length - 1; i >= 0; i--)
                    for (s = (o = t(u[i], this.document[0])).length - 1; s >= 0; s--)
                        (n = t.data(o[s], this.widgetFullName)) && n !== this && !n.options.disabled && (f.push([t.isFunction(n.options.items) ? n.options.items.call(n.element[0], e, {
                            item: this.currentItem
        ...
        _contactContainers: function(e) {
            var i, s, o, n, r, a, h, l, c, f, u = null, p = null;
            for (i = this.containers.length - 1; i >= 0; i--)
            ...
            if (u)
                if (1 === this.containers.length)
                    ...
                    for (o = 1e4,
                    n = null,
                    r = (c = u.floating || this._isFloating(this.currentItem)) ? "left" : "top",
                    a = c ? "width" : "height",
                    f = c ? "pageX" : "pageY",
                    s = this.items.length - 1; s >= 0; s--)
                        t.contains(this.containers[p].element[0], this.items[s].item[0]) && this.items[s].item[0] !== this.currentItem[0] && (h = this.items[s].item.offset()[r],
                        l = !1,
                        e[f] - h > this.items[s][a] / 2 && (l = !0),
                        o > Math.abs(e[f] - h) && (o = Math.abs(e[f] - h),
                        n = this.items[s],
        ...
        _generatePosition: function(e) {
            var i, s, o = this.options, n = e.pageX, r = e.pageY, a = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && t.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, h = /(html|body)/i.test(a[0].tagName);
    ...
    function(t, e) {
        ...
        function s(i) {
            ...
            p(a, (function(t, n) {
                var r, a = n.re.exec(i), h = a && n.parse(a), c = n.space || "rgba";
                return h ? (r = s[c](h),
                s[l[c].cache] = r[l[c].cache],
                o = s._rgba = r._rgba,
                !1) : e
            }
            )),
            o.length ? ("0,0,0,0" === o.join() && t.extend(o, n.transparent),
            s) : n[i]
        }
        function o(t, e, i) {
        ...
        h.fn = t.extend(h.prototype, {
            parse: function(o, r, a, c) {
                if (o === e)
                    return this._rgba = [null, null, null, null],
                    this;
                (o.jquery || o.nodeType) && (o = t(o).css(r),
                r = e);
                var f = this
                  , u = t.type(o)
                  , d = this._rgba = [];
                return r !== e && (o = [o, r, a, c],
                u = "array"),
                "string" === u ? this.parse(s(o) || n._default) : "array" === u ? (p(l.rgba.props, (function(t, e) {
                    d[e.idx] = i(o[e.idx], e)
                }
                )),
                this) : "object" === u ? (p(l, o instanceof h ? function(t, e) {
                ...
                : function(e, s) {
                    ...
                    f[n] && 0 > t.inArray(null, f[n].slice(0, 3)) && (f[n][3] = 1,
                    s.from && (f._rgba = s.from(f[n])))
                }
                ),
                this) : e
            },
            is: function(t) {
                ...
                return p(l, (function(t, n) {
                    var r, a = i[n.cache];
                    return a && (r = o[n.cache] || n.to && n.to(o._rgba) || [],
                    p(n.props, (function(t, i) {
            ...
            transition: function(t, e) {
                var s = h(t)
                  ...
                  , a = r[n.cache] || n.to(r._rgba)
                  , f = a.slice();
                return s = s[n.cache],
                p(n.props, (function(t, o) {
                    var n = o.idx
                      , r = a[n]
                      , h = s[n]
                      , l = c[o.type] || {};
                    null !== h && (null === r ? f[n] = h : (l.mod && (h - r > l.mod / 2 ? r += l.mod : r - h > l.mod / 2 && (r -= l.mod)),
                    f[n] = i((h - r) * e + r, o)))
                }
                )),
                this[o](f)
        ...
        l.hsla.to = function(t) {
            ...
            var e, i, s = t[0] / 255, o = t[1] / 255, n = t[2] / 255, r = t[3], a = Math.max(s, o, n), h = Math.min(s, o, n), l = a - h, c = a + h, f = .5 * c;
            return e = h === a ? 0 : s === a ? 60 * (o - n) / l + 360 : o === a ? 60 * (n - s) / l + 120 : 60 * (s - o) / l + 240,
            i = 0 === l ? 0 : .5 >= f ? l / c : l / (2 - c),
            [Math.round(e) % 360, i, f, null == r ? 1 : r]
        }
        ,
        ...
        p(l, (function(s, o) {
            ...
            h.fn[s] = function(s) {
                ...
                s === e)
                    return this[a].slice();
                var o, r = t.type(s), f = "array" === r || "object" === r ? s : arguments, u = this[a].slice();
                return p(n, (function(t, e) {
                    var s = f["object" === r ? t : e.idx];
                    null == s && (s = u[e.idx]),
                    u[e.idx] = i(s, e)
                }
                )),
            ...
            p(n, (function(e, i) {
                h.fn[e] || (h.fn[e] = function(o) {
                    var n, a = t.type(o), h = "alpha" === e ? this._hsla ? "hsla" : "rgba" : s, l = this[h](), c = l[i.idx];
                    return "undefined" === a ? c : ("function" === a && (o = o.call(this, c),
                    a = t.type(o)),
                    null == o && i.empty ? this : ("string" === a && ((n = r.exec(o)) && (o = c + parseFloat(n[2]) * ("+" === n[1] ? 1 : -1))),
                    l[i.idx] = o,
                    this[h](l)))
                }
                )
    ...
    function() {
        function e(e) {
            ...
            if (o && o.length && o[0] && o[o[0]])
                for (s = o.length; s--; )
                    "string" == typeof o[i = o[s]] && (n[t.camelCase(i)] = o[i]);
            else
                for (i in o)
                    "string" == typeof o[i] && (n[i] = o[i]);
            return n
        }
        function i(e, i) {
            var s, n, r = {};
            for (s in i)
                n = i[s],
                e[s] !== n && (o[s] || (t.fx.step[s] || !isNaN(parseFloat(n))) && (r[s] = n));
            return r
        }
        ...
        t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], (function(e, i) {
            t.fx.step[i] = function(t) {
                ("none" !== t.end && !t.setAttr || 1 === t.pos && !t.setAttr) && (a.style(t.elem, i, t.end),
                t.setAttr = !0)
            }
        }
        )),
        ...
        t.effects.animateClass = function(o, n, r, a) {
            ...
            return this.queue((function() {
                var n, r = t(this), a = r.attr("class") || "", l = h.children ? r.find("*").addBack() : r;
                l = l.map((function() {
                    return {
                        el: t(this),
                        start: e(this)
    ...
    function() {
        function e(e, i, s, o) {
            ...
            s = null,
            i = {}),
            ("number" == typeof i || t.fx.speeds[i]) && (o = s,
            s = i,
            i = {}),
            t.isFunction(s) && (o = s,
            s = null),
        ...
        t.fn.extend({
            effect: function() {
                function i(e) {
                    ...
                    var a = t(this);
                    s.mode = f.shift(),
                    !1 === t.uiBackCompat || n ? "none" === s.mode ? (a[c](),
                    i()) : o.call(a[0], s, (function() {
                        a.removeData(r),
                        t.effects.cleanUp(a),
                        "hide" === s.mode && a.hide(),
                        i()
                    }
                    )) : (a.is(":hidden") ? "hide" === c : "show" === c) ? (a[c](),
                    i()) : o.call(a[0], s, i)
                }
                ...
                return t.fx.off || !o ? c ? this[c](s.duration, l) : this.each((function() {
                    l && l.call(this)
                }
                )) : !1 === a ? this.each(u).each(i) : this.queue(h, u).queue(h, i)
            },
            show: function(t) {
                return function(s) {
                    if (i(s))
    ...
    t.effects.define("slide", "show", (function(e, i) {
        var s, o, n = t(this), r = {
            ...
            left: ["right", "left"],
            right: ["left", "right"]
        }, a = e.mode, h = e.direction || "left", l = "up" === h || "down" === h ? "top" : "left", c = "up" === h || "left" === h, f = e.distance || n["top" === l ? "outerHeight" : "outerWidth"](!0), u = {};
        t.effects.createPlaceholder(n),
        s = n.cssClip(),
        o = n.position()[l],
        u[l] = (c ? -1 : 1) * f + o,
        u.clip = n.cssClip(),
        u.clip[r[h][1]] = u.clip[r[h][0]],
